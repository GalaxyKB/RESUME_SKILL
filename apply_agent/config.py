...
class AppConfig:
    deepseek_api_key: str = _first_non_empty_env("DEEPSEEK_API_KEY", "OPENAI_API_KEY")
    deepseek_base_url: str = os.getenv("DEEPSEEK_BASE_URL", DEFAULT_DEEPSEEK_BASE_URL)
    deepseek_model: str = os.getenv("DEEPSEEK_MODEL", DEFAULT_DEEPSEEK_MODEL)
    deepseek_enable_web_search: bool = _env_bool("DEEPSEEK_ENABLE_WEB_SEARCH", default=False)
